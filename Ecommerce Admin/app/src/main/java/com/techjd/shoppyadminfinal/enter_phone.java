...
public class enter_phone extends AppCompatActivity {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(final String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                new android.os.Handler().postDelayed(
                        new Runnable() {
                            public void run() {
                                Intent otpIntent = new Intent(enter_phone.this, verify_otp.class);
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(enter_phone.this, new OnCompleteListener<AuthResult>() {
                    @Override
    ...
    private void sendUserToHome() {
        ...
        Intent homeIntent = new Intent(enter_phone.this, verify_otp.class);
